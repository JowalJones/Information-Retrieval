...
the source code into my web crawler script.  You can find this code in the resources section for this
unit.
...
if __name__ == '__main__':
    ...
    #
    print ("Enter URL to crawl (must be in the form http://www.domain.com): ")
    line = input()
 
  
    # the database is a simple dictionnary 
    db = {'term':'university', 'docid':'c1', 'tfidf':'d1', 'docfreq':'e1', 'termfreq':'f1'}
